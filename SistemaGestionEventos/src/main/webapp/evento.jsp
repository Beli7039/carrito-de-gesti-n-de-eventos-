...
<body class="container mt-4">
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td> <img src="img/<%=evento.getImagen()%>" width="80px">  </td>
				<td>
    ...
    <div class="modal fade" id="modalAgregar" tabindex="-1" aria-labelledby="modalAgregarLabel" aria-hidden="true">
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <form action="EventoServlet" method="POST" enctype="multipart/form-data">
	                <div class="modal-body">
	                    ...
	                    <div class="mb-3">
						    ...
						    <input type="file" name="imagen" class="form-control" accept="image/*" onchange="vistaPreviaImagen(event)">
						    
						    <img id="imagenPrevia" src="#" alt="Vista previa" 
						         style="display:none; margin-top:10px; width: 400px; height: 400px; object-fit: contain; border: 1px solid #ccc; border-radius: 5px;">
						</div>
	                </div>
	            ...
	            <form action="EventoServlet" method="POST" enctype="multipart/form-data">
	                <div class="modal-body">
	                    ...
	                    <div class="mb-3">
	                     ...
	                     <div class="mb-3">
				            <label class="form-label">Imagen del Evento</label>
				            <input type="file" name="imagen" class="form-control" accept="image/*" onchange="vistaPreviaImagen2(event)">				            
				            <input type="hidden" name="imagenActual" id="imagenActual">
				           
				            <img id="imagenPrevia2" src="#" alt="Vista previa" 
				                 style="display:none; margin-top:10px; width: 400px; height: 400px; object-fit: contain; border: 1px solid #ccc; border-radius: 5px;">
				        </div>
    ...
    <script>
	    function cargarEvento(idEvento) {
	        fetch("EventoServlet?metodo=editar&idEvento=" + idEvento + "&cargar=true")
	            ...
	            .then(data => {
	                ...
	                document.getElementById("imagenPrevia2").src = "img/"+data.imagen;
	                document.getElementById("imagenPrevia2").style.display = 'block';
	    ...
	    function vistaPreviaImagen(evento) {
	    ...
	    function vistaPreviaImagen2(evento) {
	        const entrada = evento.target;
	        const imagen = document.getElementById('imagenPrevia2');
